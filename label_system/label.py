...
class LabelLabelReportJob(orm.Model):
    ...
    # Schedule action:
    def clean_report_function(self, cr, uid, days=10, context=None):
    ...
    def print_report_job(self, cr, uid, ids, context=None):
        ...
        for job in report_proxy.job_ids:
            report_name = job.label_id.report_id.report_name
            res = {
                'type': 'ir.actions.report.xml',
                'report_name': report_name,
                'datas': {
...
class LabelLabelJob(orm.Model):
    ...
    _columns = {
        ...
        'has_partner_custom': fields.boolean(
            'Partner custom',
        ...
        #                               RECORD:
        # ---------------------------------------------------------------------
        'record_data_counter': fields.integer(
        ...
        'record_string_code_partner': fields.char(
            'Label partner code',
            size=40, translate=True),
        ...
        'record_string_description_partner': fields.char(
            ...
            size=40, translate=True),
        'record_string_frame': fields.char(
            'Label frame',
            size=40, translate=True),
        'record_string_fabric': fields.char(
            'Label fabric',
            size=40, translate=True),

        # Anagrafic numeric:
        'record_string_q_x_pack': fields.char(
            'Label Q. x pack',
            size=40, translate=True),
        'record_string_q_x_pallet': fields.char(
            'Label Q. x pallet',
            size=40, translate=True),
        'record_string_dimension': fields.char(
            'Label dimension',
            size=40, translate=True),
        'record_string_volume': fields.char(
            'Label volume',
            size=40, translate=True),
        'record_string_weight_net': fields.char(
            'Label weight net',
            size=40, translate=True),
        'record_string_weight_lord': fields.char(
            'Label weight lord',
            size=40, translate=True),
        'record_string_parcel': fields.char(
            'Label parcel',
            size=40, translate=True),
        'record_string_price': fields.char(
            'Label price',
            size=40, translate=True),
        ...
        # Production:
        'record_string_line': fields.char(
            'Label production line',
            size=40, translate=True),
        'record_string_period': fields.char(
            'Label period',
            size=40, translate=True),
        'record_string_lot': fields.char(
            'Label lot',
            size=40, translate=True),
        'record_string_mrp_date': fields.char(
            'Label prod. date',
            size=40, translate=True),

        # Order:
        'record_string_order_ref': fields.char(
            'Label order ref',
            size=40, translate=True), # customer
        'record_string_order_date': fields.char(
            'Label order date',
            size=40, translate=True),
        'record_string_order_deadline': fields.char(
        ...
        # Counter:
        'record_string_counter_pack_total': fields.char(
            'Label counter pack',
            size=40, translate=True),
        ...
        # Counter:
        'record_print_counter_pack_total': fields.boolean(
            'Print counter pack',
        ...
        'record_data_period': fields.char(
            'Period', size=10,
            help='Production period YYMM  format es.: 1601'),
        'record_data_lot': fields.char('Lot', size=15),
        'record_data_mrp_date': fields.char(
            'Prod. date', size=14,
            help='Production date'),
